#include <TotkToolkit/UI/Items/Windows/Editors/Texture.h>

#include <TotkToolkit/UI/Localization/TranslationSource.h>
#include <imgui.h>

namespace TotkToolkit::UI::Items::Windows::Editors {
    Texture::Texture(TotkToolkit::IO::FileHandle fileHandle, std::string name, bool* open) : TotkToolkit::UI::Items::Windows::Editor(fileHandle, name, open) {

    }
    Texture::Texture(std::shared_ptr<Formats::Resource> resource, std::string name, bool* open) : TotkToolkit::UI::Items::Windows::Editor(resource, name, open) {
