...
namespace TotkToolkit::UI::Items::Windows::Rendering {
	Viewport::Viewport(std::string name, bool* open) : TotkToolkit::UI::Items::Window(name, open), mFramebuffer(std::make_shared<TotkToolkit::Rendering::Framebuffer>(GL_FRAMEBUFFER)) {
